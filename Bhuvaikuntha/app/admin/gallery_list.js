...
export default function GalleryManagementScreen() {
  ...
  try {
    const response = await fetch("https://radhavallabha-backend-599500600776.asia-south1.run.app/api/get/Gallery");
...
const handleDelete = async (id) => {
  ...
  try {
    const response = await fetch(`https://radhavallabha-backend-599500600776.asia-south1.run.app/api/delete/gallery/${id}`, {
      method: 'DELETE',
    });
